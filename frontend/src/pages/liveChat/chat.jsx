        ...
        <div className="row ">
          <div className="col-md-4 mt-5 ">
            <div className={style.border}>
              ...
              <div className={`${style.chatContact}`}>
                {
                  <div className={`d-flex ${style.pointer} flex-row justify-content-between align-items-center py-2 px-3`}>
                    {/* <img src={`${process.env.REACT_APP_BACKEND_URL}/${e.image}`} className="rounded-circle img-fit" width={50} height={50} alt="" /> */}
                    <img src={cristian} className={`rounded-circle ${style.imgFit}`} width={50} height={50} alt="" />
                    <div className={`d-flex flex-column justify-content-between ${style.chatInfo}`}>
                      ...
                      <div className="mb-1"><b>cristante</b></div>
          ...
          <div className="col-md-8 mt-5">
            <div className={style.border}>
              ...
              <hr className='my-1' />
              <div className={`${style.chatMessage} bg-danger px-2 d-flex flex-column-reverse`}>
              ...
              <form onSubmit={(e) => {}}>
                <div className={`px-5 d-flex flex-row align-items-center bg-light ${style.msgBox}`}>
                  <div className={`w-100 ${style.sendMessage} d-flex justify-content-between align-items-center`}>
                    <input type={'text'} placeholder="Type your message..." className={`p-3`} id={style.sendMessage} />
                  </div>
                </div>
              </form>
