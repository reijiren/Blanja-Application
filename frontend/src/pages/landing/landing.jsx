      ...
      <section>
        <div className="container">
          <div className="d-flex justify-content-center mt-5">
            <img style={{ marginRight: '15px' }} className={styles.benjamin} src={left} alt="" />
            <img className={styles.benjamin} src={benjamin} alt="" />
            <img style={{ marginLeft: '15px' }} className={styles.benjamin} src={benjanin} alt="" />
            <img style={{ marginLeft: '15px' }} className={styles.benjamin} src={right} alt="" />
          </div>
          ...
          <div className="d-flex ms-4 ">
            <div className={styles.bg}>
              ...
              <h2 style={{ color: 'white', fontWeight: '700' }} className="text-center ">
                T-Shirt
              </h2>
            </div>
            ...
            <div className={styles.bg3}>
              <img className="justify-content-center ms-5 mt-1" src={bg5} alt="" />
              <h2 style={{ color: 'white', fontWeight: '700' }} className="text-center ">
                Pans
              </h2>
            </div>
